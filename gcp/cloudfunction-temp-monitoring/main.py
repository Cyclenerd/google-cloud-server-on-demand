...
# CPU temperature from the Raspberry Pi
# and writes it as a custom monitoring metric.
#
...
def temp(data: dict, context):
    ...
    series.metric.type = "custom.googleapis.com/raspi/cpu/temp"
    ...
    series.resource.labels["namespace"] = "pi"
    series.resource.labels["node_id"] = "soda"
